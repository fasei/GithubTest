...
public class Gpio
{
	 ...
	 * 解决方式：
	 * File--->Settings--->Plugins，将Android NDK Support后面的对勾去掉。
	 */
    ...
    private static final String MODULE_RST_PATH  = "/sys/class/gpio_sw/module_rst";
	...
	public static int setModuleRstHigh(boolean high){
	    String dataPath = MODULE_RST_PATH + mDataName;
		return nativeWriteGpio(dataPath, high?"1":"0");
	}
